...
class CompletedEntryTest(LucteriosTest):
    ...
    def _check_result(self):
        return self.assert_json_equal('LABELFORM', 'result', '{[b]}Produit :{[/b]} 230.62€ - {[b]}Charge :{[/b]} 348.60€ = {[b]}Résultat :{[/b]} -117.98€{[br/]}{[b]}Trésorerie :{[/b]} 1050.66€ - {[b]}Validé :{[/b]} 1244.74€')

    def _check_result_with_filter(self):
        return self.assert_json_equal('LABELFORM', 'result', '{[b]}Produit :{[/b]} 34.01€ - {[b]}Charge :{[/b]} 0.00€ = {[b]}Résultat :{[/b]} 34.01€{[br/]}{[b]}Trésorerie :{[/b]} 70.64€ - {[b]}Validé :{[/b]} 70.64€')
    ...
    def test_summary(self):
        ...
        self.assert_json_equal('LABELFORM', 'accounting_result',
                               '{[b]}Produit :{[/b]} 230.62€ - {[b]}Charge :{[/b]} 348.60€ = {[b]}Résultat :{[/b]} -117.98€{[br/]}{[b]}Trésorerie :{[/b]} 1050.66€ - {[b]}Validé :{[/b]} 1244.74€')
