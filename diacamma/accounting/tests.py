...
class ThirdTest(LucteriosTest):
    ...
    def test_listing(self):
        ...
        self.assertEqual(content_csv[5].strip(), '"1";"Dalton Avrel";"401";"0.00€";')
        self.assertEqual(content_csv[6].strip(), '"2";"Dalton Jack";"411";"0.00€";')
        self.assertEqual(content_csv[7].strip(), '"3";"Dalton Joe";"411";"0.00€";')
        self.assertEqual(content_csv[8].strip(), '"4";"Dalton William";"411";"-125.97€";')
        self.assertEqual(content_csv[9].strip(), '"5";"Luke Lucky";"411 401";"0.00€";')
        self.assertEqual(content_csv[10].strip(), '"6";"Maximum";"401";"78.24€";')
        self.assertEqual(content_csv[11].strip(), '"7";"Minimum";"411 401";"-34.01€";')
        ...
        self.assertEqual(content_csv[1].strip(), '"Liste de tiers"')
        self.assertEqual(content_csv[4].strip(), '"#";"contact";"compte";"total";')
        self.assertEqual(content_csv[5].strip(), '"1";"Dalton Joe";"411";"0.00€";')
        ...
        self.assertEqual(content_csv[1].strip(), '"Liste de tiers"')
        self.assertEqual(content_csv[4].strip(), '"#";"contact";"compte";"total";')
        self.assertEqual(content_csv[5].strip(), '"1";"Dalton William";"411";"-125.97€";')
        self.assertEqual(content_csv[6].strip(), '"2";"Maximum";"401";"78.24€";')
        self.assertEqual(content_csv[7].strip(), '"3";"Minimum";"411 401";"-34.01€";')
